...
const Spacing = ({id,spacing,setTracking, setLeading}) => {
	return (
  <div id="selectfont" className="fontsize-slider-container">

      <h5 className="txt-purewhite fontsize-head spacing-width-100">{spacing[id].name}</h5>
      <br/>
      <div className="spacing-width grid">
        <span className="txt-purewhite fontsize-head col--2">{spacing[id].label2}</span>
        ...
        <input className="fontsize-slider-input fontsize-slider-track-limited-width" type="number" value={spacing[id].leadingSize} min={spacing[id].leadingMin} max={spacing[id].leadingMax} onChange={setLeading} data-id={id}/>
      </div>
      <br/>
      <div className="gird spacing-width">
        <span className="txt-purewhite fontsize-head col--2">{spacing[id].label1}</span>
        ...
        <input className="fontsize-slider-input fontsize-slider-track-limited-width" type="number" value={spacing[id].trackingSize} min={spacing[id].trackingMin} max={spacing[id].trackingMax} onChange={setTracking} data-id={id}/>
      </div>
	</div>);
}
