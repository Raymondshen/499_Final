...
const PairFont = ({ path, fonts, setFont }) => {
	...
	return (
		<section className="grid">
			<div className="selection bg-dark col--6">
				<div className="selection-container">
					<div className="nav-selection-links">
						<div className="link-setsize p-xs-bs"><Link to={`${path}/1`}>FontSize</Link></div>
					</div>
					<div className="font-input-container grid">
						<div className="font-input-name flex-xs-parent col--12">
							<p className="font-input-header col--6">Header</p>
							<p className="font-input-body offset--7 col--6">Body</p>
						</div>
						<div className="font-input-box flex-xs-parent w-100 col--12">
							<input className="font-input col--6" type="text" value={fonts.first} onChange={changeFontOne} />
							<input className="font-input offset--7 col--6" type="text" value={fonts.second} onChange={changeFontTwo} />
						</div>
					</div>
				</div>
				<ClickList
			...
			<div className="preview col--6 offset--7 pairing-wrapper">
				<PairingDoc
					fontSize={72}
